...
| <a name="input_destination_bucket_component_name"></a> [destination\_bucket\_component\_name](#input\_destination\_bucket\_component\_name) | The name of the component that will be using the destination bucket | `string` | `"s3-bucket/cloudwatch"` | no |
| <a name="input_enabled"></a> [enabled](#input\_enabled) | Set to false to prevent the module from creating any resources | `bool` | `null` | no |
| <a name="input_encryption_enabled"></a> [encryption\_enabled](#input\_encryption\_enabled) | Enable encryption for the Kinesis Firehose Delivery Stream | `bool` | `true` | no |
